 ...
 * @returns {JSX.Element}
 */
const FormLocationAutocomplete = ({ location = '', setLocation = () => {}, setError = () => {}, onSubmit = () => {}, placeholder = '', name = 'form-location-autocomplete', submitLabel = 'Search', activeGeolocation = false }) => {
     ...
     */
    return (
        <form className="flex flex-wrap h-16" onSubmit={beforeSubmit}>
            <div 
            ...
            >
                ...
                <input 
                    ...
                    id={name}
                    name={name}
                    className={`grow h-full pl-16 pr-4 leading-4 bg-white shadow placeholder:text-neutral-500 text-lg ${activeGeolocation ? 'pr-16' : 'pr-4'}`}
                    ...
                    >
                        {options.map(( option, index ) => (
                            <li 
                                ...
                                className={`relative flex items-center w-full h-16 ${index === hoveredOption ? 'bg-sky-50' : '' }`}
                                tabIndex="-1"
                            ...
                            >
                                <span className="absolute inset-y-0 left-0 flex justify-center items-center aspect-square" aria-hidden="true">
                                ...
                                <span className="grow overflow-hidden pl-16 pr-4 truncate text-ellipsis text-neutral-600 leading-8 text-left text-lg">
                                    {option.label}
                                </span>
                            </li>
                        ))}
            ...
            <button 
                type="submit"
                className="shrink-0 h-full px-16 bg-sky-500 shadow text-white text-lg"
            >
                {submitLabel}
            </button>
        </form>
