    ...
    return (
        <div className="relative flex w-full h-16">
            {!!label && (
                <label 
                    htmlFor={name}
                    className="absolute inset-y-0 left-0 flex justify-center items-center aspect-square text-neutral-500" 
                    aria-hidden="true"
                >
                    {label}
                </label>
            ...
            <input 
                className={`flex justify-between items-center grow h-full leading-4 bg-white shadow text-lg text-left placeholder:text-neutral-500 ${label ? 'pl-16' : 'pl-4'} ${password ? 'pr-16' : 'pr-4'}`}
